...
export function ProductDetailPage() {
  ...
  return (
    <div className="flex-1 bg-white pb-24 min-h-0">
      ...
      {/* 3. Features Section - Figma Node 37:3940 명세 100% 동기화 */}
      ...
      {/* 6. Purchase Button (Fixed Bottom) - Figma effect_KE6XF6 명세 */}
      <div className="fixed bottom-0 left-1/2 z-40 flex w-full max-w-[376.04px] -translate-x-1/2 gap-[10px] border-t border-separator bg-white p-[14px] shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
        <button
          type="button"
          className="flex h-[49px] w-[49px] items-center justify-center rounded-[5px] border border-[#D9D9D9] bg-white text-[#322927] active:scale-95 transition-all shadow-sm"
        >
